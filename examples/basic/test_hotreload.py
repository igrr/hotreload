...
if __name__ == "__main__":
    print("Run with:")
    print("  Unit tests:  pytest test_hotreload_e2e.py::test_hotreload_unit_tests -v -s --embedded-services idf,qemu")
    print("  E2E test:    pytest test_hotreload_e2e.py::test_hot_reload_e2e -v -s --embedded-services idf,qemu")
